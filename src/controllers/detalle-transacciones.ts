    ...
    let sql2 = {
      dataSql: [
        `select * from (
          ...
          union select 'Transferencias Entre Cuentas IDEPRO/TECHREO' as Operacion,catrn.catrnfpro fecha, 'Transferencia Movil de Tercero' as detalle, catrn.catrnimpo*-1 monto, (case when catrn.catrnimpo > 0 then 'Retiro' else 'Deposito' end ) tipo_operacion,catrn.catrnhora hora,catrn.catrnntra nro_transaccion, ''||(select gbagenomb from catrn catrn_, camca, gbage   where catrn_.catrnncta = camcancta and camcacage = gbagecage and catrn_.catrnntra = catrn.catrntorg) origen_destino,''||(select  catrn_.catrnncta from catrn catrn_ where catrn_.catrnntra = catrn.catrntorg) nro_cuenta_origen_destino,'' banco,'' nro_dpf,catrn.catrnglos glosa from catrn where catrn.catrnpref = 3 and (catrn.catrnimpo*-1) > 0 and catrn.catrncorr = 3 and catrn.catrnncta in (select camcancta from camca where camcastat = 1 and camcacage = ${codigoCliente})
          union select 'Transferencias Entre Cuentas IDEPRO/TECHREO' as Operacion,catrn.catrnfpro fecha, 'Transferencia Movil a Tercero' as detalle, catrn.catrnimpo*-1 monto, (case when catrn.catrnimpo > 0 then 'Retiro' else 'Deposito' end ) tipo_operacion,catrn.catrnhora hora,catrn.catrnntra nro_transaccion, ''||(select gbagenomb from catrn catrn_, camca, gbage   where catrn_.catrnncta = camcancta and camcacage = gbagecage and catrn_.catrnntra = catrn.catrntorg) origen_destino,''||(select  catrn_.catrnncta from catrn catrn_ where catrn_.catrnntra = catrn.catrntorg) nro_cuenta_origen_destino,'' banco,'' nro_dpf,catrn.catrnglos glosa from catrn where catrn.catrnpref = 3 and (catrn.catrnimpo*-1) < 0 and catrn.catrncorr = 3 and catrn.catrnncta in (select camcancta from camca where camcastat = 1 and camcacage = ${codigoCliente})
          union select 'Transferencias Interbancarias' as Operacion,tetrnfpro fecha, 'Transferencias Interbancarias' as detalle, tetrnimpo*-1 monto, (case when tetrnimpo > 0 then 'Retiro' else 'Deposito' end ) tipo_operacion,tetrnhora hora,tetrnntra nro_transaccion, ''||tetrnnomx origen_destino, ''||tetrnnctx nro_cuenta_origen_destino,(select tecondesc from tecon  where teconcomd = 1  and teconcorr = tetrncenx) banco,'' nro_dpf,tetrnglos glosa from tetrn where   tetrnidqr is null and  tetrnnvia in (select camcancta from camca where camcastat = 1 and camcacage = ${codigoCliente})
          ...
          union select  'Cobro Simple QR' as Operacion,tetrnfpro fecha, 'Cobro QR' as detalle, tetrnimpo*-1 monto, (case when tetrnimpo > 0 then 'Retiro' else 'Deposito' end ) tipo_operacion,tetrnhora hora,tetrnntra nro_transaccion, ''||tetrnnomx origen_destino,''|| tetrnnctx nro_cuenta_origen_destino,'Idepro/Otro Banco' banco,'' nro_dpf,tetrnglos glosa from tetrn where tetrnidqr is not null and (tetrnimpo*-1)>= 0 and tetrnnvia in (select camcancta from camca where camcastat = 1 and camcacage = ${codigoCliente})
          union select  'Pago Simple QR' as Operacion,tetrnfpro fecha, 'Pago QR' as detalle, tetrnimpo*-1 monto, (case when tetrnimpo > 0 then 'Retiro' else 'Deposito' end ) tipo_operacion,tetrnhora hora,tetrnntra nro_transaccion,''|| tetrnnomx origen_destino,''|| tetrnnctx nro_cuenta_origen_destino, 'Idepro/Otro Banco' banco,'' nro_dpf,tetrnglos glosa from tetrn where tetrnidqr is not null and (tetrnimpo*-1)<= 0 and tetrnnvia in (select camcancta from camca where camcastat = 1 and camcacage = ${codigoCliente})
          union select 'Cobro Simple QR' as Operacion,catrn.catrnfpro fecha, 'Cobro QR' as detalle, catrn.catrnimpo*-1 monto, (case when catrn.catrnimpo > 0 then 'Retiro' else 'Deposito' end ) tipo_operacion,catrn.catrnhora hora,catrn.catrnntra nro_transaccion, ''||(select gbagenomb from catrn catrn_, camca, gbage   where catrn_.catrnncta = camcancta and camcacage = gbagecage and catrn_.catrnntra = catrn.catrntorg) origen_destino,''||(select  catrn_.catrnncta from catrn catrn_ where catrn_.catrnntra = catrn.catrntorg) nro_cuenta_origen_destino,'' banco,'' nro_dpf,catrn.catrnglos glosa from catrn where SUBSTR(catrn.catrnglos, 1, 3) = 'QR.' and catrn.catrnpref = 3 and (catrn.catrnimpo*-1) > 0 and catrn.catrncorr = 3 and catrn.catrnncta in (select camcancta from camca where camcastat = 1 and camcacage = ${codigoCliente})
          union select 'Pago Simple QR' as Operacion,catrn.catrnfpro fecha, 'Pago QR' as detalle, catrn.catrnimpo*-1 monto, (case when catrn.catrnimpo > 0 then 'Retiro' else 'Deposito' end ) tipo_operacion,catrn.catrnhora hora,catrn.catrnntra nro_transaccion, ''||(select gbagenomb from catrn catrn_, camca, gbage   where catrn_.catrnncta = camcancta and camcacage = gbagecage and catrn_.catrnntra = catrn.catrntorg) origen_destino,''||(select  catrn_.catrnncta from catrn catrn_ where catrn_.catrnntra = catrn.catrntorg) nro_cuenta_origen_destino,'' banco,'' nro_dpf,catrn.catrnglos glosa  from catrn where SUBSTR(catrn.catrnglos, 1, 3) = 'QR.' and catrn.catrnpref = 3 and (catrn.catrnimpo*-1) < 0 and catrn.catrncorr = 3 and catrn.catrnncta in (select camcancta from camca where camcastat = 1 and camcacage = ${codigoCliente})
